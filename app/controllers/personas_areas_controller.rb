class PersonasAreasController < ApplicationController
  ...
  def index
    @personas_areas = PersonasAreaView.order(id: :DESC)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @personas_area.save
        format.html { redirect_to personas_areas_url, notice: "Personas area was successfully created." }
  ...
  def update
    ...
    respond_to do |format|
      if @personas_area.update(personas_area_params)
        format.html { redirect_to personas_areas_url, notice: "Personas area was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to personas_areas_url, notice: "La Persona-Area <strong >#{@personas_area.persona.nombre}</strong> - <strong style='color: #{@personas_area.area.codigo_hex}'>#{@personas_area.area.nombre}</strong> ha sido Eliminado.".html_safe }
  ...
  def inactivar_personas_area
    ...
    respond_to do |format|
      if @personas_area.save
        format.html { redirect_to personas_areas_url, notice: "La Persona-Area <strong >#{@personas_area.persona.nombre}</strong> - <strong style='color: #{@personas_area.area.codigo_hex}'>#{@personas_area.area.nombre}</strong> ha sido Inactivado.".html_safe }
        format.json { render :show, status: :created, location: @personas_area }
      else
  ...
  def activar_personas_area
    ...
    respond_to do |format|
      if @personas_area.save
        format.html { redirect_to personas_areas_url, notice: "La Persona-Area <strong >#{@personas_area.persona.nombre}</strong> - <strong style='color: #{@personas_area.area.codigo_hex}'>#{@personas_area.area.nombre}</strong> ha sido Activado.".html_safe }
        format.json { render :show, status: :created, location: @personas_area }
      else
  ...
  private
    ...
    def personas_area_params
      params.require(:personas_area).permit(:descripcion, :user_created_id, :user_updated_id, :estado, :persona_id, :area_id)
    end
end
